...
const {getAppByMonth} = require('../helpers/getAppointmentsByMonth');
...
const getAppointmentsByUser = async (req, res = response) => {
  ...
  try {
    ...
    const listSorted = appointments.sort((a, b) => {
...
const getAppointmentsByProfessional = async (req, res = response) => {
  ...
  try {
    const appointments = await Appointment.find({ professional }).populate(
      'user'
    );
...
const getAppointmentsByMonth = async (req, res = response) => {
